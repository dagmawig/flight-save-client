...
export default function Header() {
    return (
        <Box sx={{ position: "sticky", top: 0, zIndex: 20,  width: "100%", height: "50px", display: "flex", justifyContent: 'space-between', backgroundColor: "info.main", padding: 0, marginBottom: "5px", marginTop:0 }}>
