...
export default function Footer() {
    return (
        <Box sx={{ position: "sticky", bottom: 0, zIndex: 20, width: "100%", height: "30px", display: "flex", justifyContent: 'space-between', alignItems: "center", backgroundColor: "info.main", padding: 0, margin: 0 }}>
